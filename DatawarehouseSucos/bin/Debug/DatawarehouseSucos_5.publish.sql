...
GO
PRINT N'Rename refactoring operation with key 2a7e20aa-a4bb-4569-b093-a58cf0975672 is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key e6f99961-3b93-49e3-bff9-68a2fe9d52ab is skipped, element [dbo].[Fato_001].[CustoVariavel] (SqlSimpleColumn) will not be renamed to Custo_Variavel';
